...
const CustomTabPanel: React.FC<React.PropsWithChildren<TabPanelProps>> = (
  props: TabPanelProps,
) => {
...
const KeywordSearchFormTab = (props: {
  query: SearchQuery;
  onSubmit: () => void;
  onQueryUpdate: (_: SearchQuery) => void;
}) => {
    ...
    <Mui.Stack sx={{ paddingTop: 1 }} direction="column">
      <Mui.Stack sx={{ py: 1 }} direction="column">
        ...
        <Mui.Button
          ...
          variant="contained"
          color="primary"
          disabled={props.query.keyword.length === 0}
        >
          検索
        </Mui.Button>
      </Mui.Stack>
...
const DateRangeSearchFormTab = (props: {
  query: SearchQuery;
  onSubmit: () => void;
  onQueryUpdate: (_: SearchQuery) => void;
}) => {
...
const DateInSearchFormTab = (props: {
  query: SearchQuery;
  onSubmit: () => void;
  onQueryUpdate: (_: SearchQuery) => void;
}) => {
      ...
      <Mui.FormControl sx={{ width: "480px" }}>
        ...
        <Mui.Box sx={{ padding: 1 }}>
          <CustomTabPanel value={tabIndex} index={0}>
            <KeywordSearchFormTab
              query={context.searchQuery}
              onSubmit={props.onSubmit}
              onQueryUpdate={context.setSearchQuery}
            />
          </CustomTabPanel>
